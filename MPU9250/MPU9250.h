...
public:
    ...
    enum AccelScale {
        ...
        SCALE_4G = BITS_FS_4G,
        SCALE_8G = BITS_FS_8G,
        SCALE_16G = BITS_FS_16G,
    };
    
    enum GyroScale {
        SCALE_250DPS = BITS_FS_250DPS,
        SCALE_500DPS = BITS_FS_500DPS,
        SCALE_1000DPS = BITS_FS_1000DPS,
        SCALE_2000DPS = BITS_FS_2000DPS,
    };
...
private:
    ...
    void readBytes(byte addr, byte* data, int length);
